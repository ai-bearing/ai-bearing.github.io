...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \small\resumeItem{Requested to do so by professor}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \small\resumeItem{Writer of Opinion and Community News pieces for student-run newspaper}
        \resumeItem{Reported stories include ``Taco glory: Villa's Tacos opens brick-and-mortar restaurant in Highland Park'' and ``The timeless work of Eric Warren keeps Eagle Rock history alive''}
        \resumeItem{Opinion pieces include ```Equity' without action is just a word'' and ``Politicians should not be put on pedestals''}
        \resumeItemListEnd
    \resumeSubheading
    {Grader, Intermediate Microeconomics}{February, 2022 -- April, 2022}
    {Occidental College}{Los Angeles, CA}
