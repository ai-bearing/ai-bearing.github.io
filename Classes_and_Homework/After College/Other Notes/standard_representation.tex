...
\begin{proposition}
  ...
  \end{enumerate}
\end{proposition}
We have $u^{\ast}u$ is the source projection onto $\ker\left( x \right)^{\perp}$ and $uu^{\ast}$ is the range projection onto $\img\left( x \right)$, denoted $s_r(x)$ and $s_{l}(x)$ respectively. We call them the right support and left support of $x$ respectively.
