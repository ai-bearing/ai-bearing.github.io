...
The most important representation is the representation on $L_2(G)$ induced by the action of $G$ on itself by left-multiplication. This defines $\left( \lambda(g)f \right)(y) = f\left( x^{-1}y \right)$.
