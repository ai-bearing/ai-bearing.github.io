...
\end{proof}
The standard representation in fact generalizes to a wider setting --- namely, $\tau$ can be merely a faithful normal state instead of having to be a trace. This is the realm of Tomita--Takesaki Theory.
...
\begin{proposition}\hfill
  \begin{enumerate}[(i)]
    \item We have
    \begin{align*}
      E_A\left( u_{g} \right) &= \chi_{\set{x = g^{-1}x}}
    \end{align*}
    for all $g\in \left[ \mathcal{R} \right]$.
    \item We have $e_D\left( x\xi_0 \right) = E_A(x)\xi_0$ for all $x\in L\left( \mathcal{R} \right)$.
  \end{enumerate}
\end{proposition}
\begin{proof}
  It suffices to show that $E_A\left( u_{\phi} \right) = \chi_{\set{x = \phi^{-1}(x)}}$ for all $\phi\in \left[ \left[ \mathcal{R} \right] \right]$. For this, let $\phi,\psi\in \left[ \left[ \mathcal{R} \right] \right]$. Then, if $f = \chi_{\set{x = \phi^{-1}(x)}}$, we have
  \begin{align*}
    \tau\left( E_A\left( u_{\phi} \right)u_{\psi} \right) &= \int_{X}^{} E_A\left( u_{\phi} \right)(x)\chi_{\set{x = \psi^{-1}(x)}}\:d\mu(x)\\
                                                          &= \int_{X}^{} E_A\left( u_{\phi}\chi_{\set{x = \psi^{-1}(x)}} \right)\:d\mu(x)\\
                                                          &= \tau\left( E_A\left( u_{\phi}\chi_{\set{x = \psi^{-1}(x)}} \right) \right)\\
                                                          &= \tau\left( u_{\phi}\chi_{\set{x = \psi^{-1}(x)}} \right)\\
                                                          &= \int_{X}^{} \chi_{\set{x = \psi^{-1}(x)}}f(x)\:d\mu(x)\\
                                                          &= \int_{}^{} f(x)\chi_{\set{x = \psi^{-1}(x)}}\:d\mu(x)\\
                                                          &= \tau\left( fu_{\psi} \right),
  \end{align*}
  so that $\tau\left( \left( E_A\left( u_{\phi} \right)-f \right)x \right) = 0$ for any $x\in M$, meaning that $E_{A}\left( u_{\phi} \right) = f$.
\end{proof}
