...
It is possible to turn a graph into a geodesic space by gluing any two vertices connected by an edge using a unit interval. In fact, this applies to any quasi-geodesic space, and the resulting geodesic space is quasi-isometric to the original quasi-geodesic space.
