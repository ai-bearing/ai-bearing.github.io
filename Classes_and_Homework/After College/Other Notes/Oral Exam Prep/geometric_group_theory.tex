...
\end{align*}
where we note that $\operatorname{Cay}\left( G,S \right)$ is edge-symmetric with respect to $s\mapsto s^{-1}$, meaning that we will require $B\left( q,r \right)$ to be edge-symmetric as well.
