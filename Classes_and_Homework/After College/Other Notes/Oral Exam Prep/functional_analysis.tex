...
\begin{theorem}[Goldstine's Theorem]
  Let $X$ be a normed space. Then, $B_X$ is weak*-dense in $X^{\ast\ast}$.
\end{theorem}
\begin{proof}
...
\begin{theorem}
  ...
  \begin{enumerate}[(a)]
    ...
    \item the weak* topology on $X^{\ast}$ coincides with the weak topology on $X^{\ast}$ induced by $X^{\ast\ast}$;
