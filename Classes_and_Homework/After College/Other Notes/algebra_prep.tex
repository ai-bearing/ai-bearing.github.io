...
If $G$ acts on its \textit{subgroups} by conjugation, then the \textit{normalizer} of $H\leq G$, denoted $N_G(H)$, is the stabilizer of $H$ under conjugation. Similarly, number of subgroups conjugate to $H\leq G$ is given by $\left[ G:N_G(H) \right]$.
