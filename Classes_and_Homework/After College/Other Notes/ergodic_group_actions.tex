...
\end{proof}
We can now translate the criteria for pmp actions of groups to the Koopman representation restricted to $L_2\left( X,\mu \right)\ominus \C 1$, which will require a certain level of care. For brevity, write $\mu(f) = \int_{X}^{} f\:d\mu$.
\begin{theorem}
