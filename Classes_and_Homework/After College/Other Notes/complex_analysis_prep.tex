...
\begin{example}
  We wish to evaluate
  \begin{align*}
    I &= \int_{0}^{2\pi} \frac{1}{\left( a + b\sin\left( \theta \right) \right)^2}\:d\theta,
  \end{align*}
  where $a > b > 0$ are real numbers. Towards this end, we let $z = e^{i\theta}$. Then, $dz = ie^{i\theta}d\theta$, or $d\theta = \frac{1}{iz}dz$. Additionally, we have
  \begin{align*}
    \sin\left( \theta \right) &= \frac{1}{2i} \left( z - \frac{1}{z} \right),
  \end{align*}
  whence
  \begin{align*}
    I &= \oint_{S^{1}}^{} \frac{1}{iz\left( a + \frac{b}{2i}\left( z + \frac{1}{z} \right) \right)^2} \:dz\\
      &= \oint_{S^{1}}^{} \frac{1}{iz\left( a + \frac{b}{2i}\left( \frac{z^2 + 1}{z} \right) \right)^2}\:dz\\
      &= \oint_{S^{1}}^{} \frac{z^2}{iz\left( \frac{b}{2i} z^2 + az + \frac{b}{2i} \right)^2}\:dz\\
      &= \oint_{S^{1}}^{} \frac{z}{i\left( \frac{b}{2i}\left( z^2 + \frac{2ia}{b}z + 1 \right) \right)^2}\:dz\\
      &= \oint_{S^{1}}^{} \frac{4iz}{b^2 \left( z-i\left( \frac{-a + \sqrt{b^2 + a^2}}{b} \right) \right)^2\left( z-i\left( \frac{-a - \sqrt{b^2 + a^2}}{b} \right) \right)^2}\:dz
  \end{align*}
\end{example}
\section{Old Exams}%
\section{Notation}%
