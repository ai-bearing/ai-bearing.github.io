...
\begin{example}
  We wish to evaluate
  \begin{align*}
    I &= \int_{0}^{2\pi} \frac{1}{\left( 3 + \sin\left( \theta \right) \right)^2}\:d\theta,
  \end{align*}
  where $a > b > 0$ are real numbers. Towards this end, we let $z = e^{i\theta}$. Then, $dz = ie^{i\theta}d\theta$, or $d\theta = \frac{1}{iz}dz$. Therefore, we get
  \begin{align*}
    I &= \oint_{S^{1}}^{} \frac{1}{\left( 3 + \frac{1}{2i}\left( z + \frac{1}{z} \right) \right)^2} \frac{1}{iz}\:dz\\
      &= \oint_{S^{1}}^{} \frac{}{\left( 3 + \frac{1}{2i}\left( \frac{z^2 + 1}{z} \right) \right)^2}\frac{1}{iz}\:dz\\
      &= 
  \end{align*}
\end{example}
\section{Old Exams}%
