...
\begin{solution}\hfill
  \begin{enumerate}[(a)]
    ...
    \item Let $N = \ker\left( f \right)$, and let $P_0$ be a $p$-Sylow subgroup of $N$. By the second Sylow theorem, there is a $p$-Sylow subgroup of $G$, $P_1$, such that $P_0\subseteq P_1$. 
  \end{enumerate}
\end{solution}
