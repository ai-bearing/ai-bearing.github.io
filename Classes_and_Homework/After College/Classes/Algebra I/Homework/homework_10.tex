...
\end{problem}
\begin{solution}
  Taking a prime factorization of $351$ gives $351 = 3^2\cdot 29$. Therefore, this is a group of the form $p^2\cdot q$, where $p < q$. In particular, the number of $3$-Sylow subgroups must divide $29$ and be equivalent to $1$ modulo $3$, so that there is exactly one $3$-Sylow subgroup, which is necessarily normal.
\end{solution}
