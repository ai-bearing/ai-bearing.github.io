...
\end{problem}
\begin{solution}
  Choose a rectangular contour $\gamma_R$ given by the rectangle with side length $2R$ and height going from $-\pi i$ to $\pi i$. This yields
  \begin{align*}
...
\begin{problem}[Problem 3]
  ...
  \begin{align*}
    \int_{-\infty}^{\infty} \frac{\cos\left( \xi x \right)}{x^2 + 4x + 5}\:dx &= \lim_{R\rightarrow\infty} \int_{-R}^{R} \frac{\cos\left( \xi x \right)}{x^2 + 4x + 5}\:dx.
  \end{align*}
\end{problem}
\begin{solution}
  First, if $\xi = 0$, then
  ...
  \end{align*}
  In closed form, this yields the solution
  \begin{align*}
    \int_{-\infty}^{\infty} \frac{\cos\left( \xi x \right)}{x^2 + 4x + 5}\:dx &= \pi e^{-\left\vert \xi \right\vert}\cos\left( 2\xi \right).
  \end{align*}
\end{solution}
...
\begin{solution}
  ...
  Suppose $\xi > 0$. Let $\gamma_{R}$ be the rectangular contour in the lower half-plane with horizontal side length $2R$ and height $R$ sitting on the real axis that enters the lower half-plane. Then,
  \begin{align*}
  ...
  \begin{align*}
    ...
    &\rightarrow 0\\
    \left\vert e^{2\pi \xi R}\int_{R}^{-R} \frac{\left( x + iR \right)^3}{\left( \left( x + iR \right)^2 + 1 \right)^2}\:dx \right\vert
    &\leq e^{2\pi \xi R}\frac{ 2R }{\inf_{-R\leq x\leq R} \left\vert \left( x+iR \right) + \frac{2}{\left( x+iR \right)} + \frac{1}{\left( x+iR \right)^3} \right\vert}\\
    &\leq e^{2\pi \xi R} \frac{1}{1 - \frac{2}{R^2} - \frac{1}{R^4}}\\
    &\rightarrow 0,
  \end{align*}
