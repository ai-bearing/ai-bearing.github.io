...
Consider a system of standard probability spaces $\left( X_k,\Sigma_k \right)_{k=1}^{\infty}$ with connecting maps $\varphi_{k}\colon X_{k+1}\rightarrow X_k$ satisfying $\left( \varphi_k \right)_{\ast}\mu_{k+1} = \mu_k$.
