...
\begin{solution}\hfill
  \begin{enumerate}[(a)]
    \item We observe that $G$ and $H$ have the same order of $p\left( p-1 \right)$. Therefore, if we show that there is an injective homomorphism from $G$ to $H$, then this homomorphism is automatically surjective.
