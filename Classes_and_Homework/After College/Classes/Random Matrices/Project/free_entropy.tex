...
\end{align*}
where $m$ is the Lebesgue measure on $\R^{N^2}$ and $\tr$ denotes the normalized trace. It can be shown, as in \cite[Theorem 2.5.2]{anderson_guionnet_zeitouni}, that the joint distribution of the eigenvalues $\lambda_1(X) \leq\cdots\leq \lambda_N(X)$ has density given by
\begin{align*}
