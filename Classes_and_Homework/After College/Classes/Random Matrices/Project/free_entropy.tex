...
\begin{align*}
  \mathbb{P}_{\ve}\left( a_1,\dots,a_n \right) &= \sup_{R > 0}\inf_{m\in\N}\inf_{\gamma > 0}\limsup_{k\rightarrow\infty}\left( \frac{1}{k^2}P_{\ve}\left( \Gamma_{R}\left( a_1,\dots,a_n;m,k,\gamma \right) \right),\rho_k \right)\\
  \mathbb{K}_{\ve}\left( a_1,\dots,a_n \right) &= \sup_{R > 0}\inf_{m\in\N}\inf_{\gamma > 0}\limsup_{k\rightarrow\infty}\left( \frac{1}{k^2}K_{\ve}\left( \Gamma_{R}\left( a_1,\dots,a_n;m,k,\gamma \right) \right),\rho_k \right),
\end{align*}
