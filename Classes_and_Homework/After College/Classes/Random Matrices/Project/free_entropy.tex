...
Yet, the next step is to move from the sequence of partial sums to developing a large deviation principle for the empirical distribution itself. This will give us the idea of classical entropy.
