...
\begin{corollary}
  ...
  \end{align*}
\end{corollary}
One of the main benefits of the packing number approach is that it lends itself to a version of entropy known as \textit{$1$-bounded entropy}. The main difference between 
