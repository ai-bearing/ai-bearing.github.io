...
\begin{solution}
  ...
  \end{align*}
  Let $p\in M$ and $U\subseteq M$ a chart for $p$ with coordinates $\left( x_1,\dots,x_n \right)$. Then, we observe that the $1$-form $\omega_X$ defined via the Riemannian metric, $\omega_X\left( Y \right) = g\left( X,Y \right)$, is given locally by
  \begin{align*}
  ...
  \end{align*}
  Computing the divergence, which is given by $\ast d \ast \left( \omega_X \right)$, we find that
  \begin{align*}
