...
\begin{proof}
  ...
  Now, suppose that $\omega\in \mathcal{A}^{0,\ell}\left( \mathcal{U} \right)$ satisfies $\delta\omega = 0$. Then, for any $\alpha,\beta\in A$, we have $\omega\left( \alpha \right)|_{U_{\alpha}\cap U_{\beta}} = \omega\left( \beta \right)|_{U_{\alpha}\cap U_{\beta}}$, whence $\omega$ is a differential form defined on the whole of $M$, meaning $\omega\in \img\left( r \right)$.\newline
