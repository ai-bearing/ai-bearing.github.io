...
\end{align*}
is nonsingular. We will prove two important facts:
\begin{itemize}
  \item Morse functions exist (and in fact there are sufficiently many such functions);
  \item Morse functions give a \href{https://ncatlab.org/nlab/show/CW+complex}{CW complex} structure for $M$ around the critical points.
\end{itemize}
