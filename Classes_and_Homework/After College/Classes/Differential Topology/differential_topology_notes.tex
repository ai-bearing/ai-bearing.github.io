...
\begin{remark}
  ...
  \begin{center}
    % https://tikzcd.yichuanshen.de/#-ML7hNSutNjtXCodIdjqcnj49K93rUeIlzulqL8bndxo8QCCYNtdm5IUcTqsynDqitkfVUf10YNhgCSrCZro5gslkiKFwgA
\begin{tikzcd}
U \arrow[rr, "f"] \arrow[dd, "\varphi_1"', bend right] \arrow[dd, "\varphi_2", bend left] &  & V \arrow[dd, "\psi_1", bend left] \arrow[dd, "\psi_2"', bend right] \\
                                                                                          &  &                                                                     \\
\mathbb{R}^{n} \arrow[rr, "F_2", bend left] \arrow[rr, "F_1"', bend right]                &  & \mathbb{R}^{k}                                                     
\end{tikzcd}
  \end{center}
  To see this, notice that by applying differentials, we obtain the following diagram.

  \begin{center}
  % https://tikzcd.yichuanshen.de/#-K02Lp7dPoGhjkxpMZjk9mV0tUTkdzs1ENdbosYCs1m5nq93nMJF9fH86P1Bp0wTxEhDEBkapVqLCWp8fHo8QShhVwQdEHljrVqY04Td5kiUY8Nlsdli2mx9GhsETWeUOZSzjyrnzsfTJdKWfz7qiniAXm9dhEuEA
  \begin{tikzcd}
  U \arrow[rrr, "f"] \arrow[ddd, "\varphi_1"', bend right] \arrow[ddd, "\varphi_2", bend left]                 &  &  & V \arrow[ddd, "\psi_1", bend left] \arrow[ddd, "\psi_2"', bend right] \\
                                                                                                               &  &  &                                                                       \\
                                                                                                               &  &  &                                                                       \\
  \mathbb{R}^{n} \arrow[rrr, "D_{\varphi_2(p)}F_2", bend left] \arrow[rrr, "D_{\varphi_1(p)}F_1"', bend right] &  &  & \mathbb{R}^{k}                                                       
  \end{tikzcd}
  \end{center}
