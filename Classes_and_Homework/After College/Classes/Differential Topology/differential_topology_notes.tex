...
\begin{definition}
  ...
  \begin{align*}
    \pd{^{\left\vert \alpha \right\vert}f}{\partial x_1^{\alpha_1}\cdots \partial x_n^{\alpha n}}
  \end{align*}
  are continuous. Here, $\alpha = \left( \alpha_1,\dots,\alpha_n \right)$ is a \textit{multi-index}, where $\alpha_{i}\geq 0$ for each $i$, and $\left\vert \alpha \right\vert = \sum_{i=1}^{n}\alpha_i$.
\end{definition}
