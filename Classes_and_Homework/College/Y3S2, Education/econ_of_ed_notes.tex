...
\subsection{Education: how much?}%
  ...
  \begin{description}
    ...
    \item[Forms of State Aid:] States support school funding through using state tax money to shift budget constraints in the locality ($B = X + R$).
      \begin{itemize}
        \item Block grant: unconditional funding for district.
        \item Matching grant: funding for district proportional to its spending.
        \item Categorical aid: funding for particular classes of students (low-income, special needs).
        \item Equalization aid: directly aimed at reducing financial inequities at the district level.
      \end{itemize}
  \end{description}
