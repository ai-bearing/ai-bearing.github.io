...
\subsection{Education: how much?}%
  ...
  \end{itemize}
  \section{Arcidiacono et al., ``Racial Preferences in University Admissions''}%
  \begin{itemize}
    \item David Card points out that Arcidiacono et al. leave out ALDC and artistic/musical admits --- however, that is a non-trivial proportion of the data (25\%).
    \item Arcidiacono et al. argue that ALDC applicants face a different admission process than academic admits. Looking at ALDC applicants in a different paper, however, they don't actually look at it.
    \item However, at the same time, Arcidiacono et al. may not account for all OVB.
    \item Potential solutions: selecting for diversity on other factors, lottery above a certain test score cutoff.
  \end{itemize}
\end{document}
