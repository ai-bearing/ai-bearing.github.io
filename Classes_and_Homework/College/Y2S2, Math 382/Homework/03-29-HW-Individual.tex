...
\begin{document}
  ...
  \begin{problem}{3.1.5}
    ...
    \begin{align*}
      \alpha(G) + \beta(G) &= n(G) \\
      \alpha(G) &= n(G) - \beta(G) \\
      \alpha(G) &\geq n(G) - \alpha(G)\Delta(G) \tag*{since $\alpha(G)\Delta(G)$ must cover every edge} \\
  ...
  \begin{problem}{3.1.28}
    ...
    \end{center}
    \tcblower
    The minimum edge cover is as follows, and is of size $22$, meaning that the maximum matching is of size $20$, which is not a perfect matching.
    \begin{center}
