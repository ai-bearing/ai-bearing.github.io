...
\end{enumerate}
  ...
  \begin{align*}
    (\forall \varepsilon > 0)(\exists N\in \N)\ni n\geq N&\Rightarrow D_{u}(f_n,f) < \varepsilon\\
                                                         &\Leftrightarrow\\
    (\forall \varepsilon > 0)(\exists N\in \N)\ni n\geq N&\Rightarrow \sup_{x\in\Omega}d(f_n(x),f(x)) < \varepsilon\\
                                                         &\Leftrightarrow\\
    (\forall \varepsilon > 0)(\exists N\in \N)\ni n\geq N&\Rightarrow \forall x,~d(f_n(x),f(x)) < \varepsilon.
  \end{align*}
