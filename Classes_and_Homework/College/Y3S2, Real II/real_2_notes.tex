...
\end{enumerate}
  ...
  Let $(X,d)$ be a complete metric space, and $F_1\supseteq F_2\supseteq \cdots$ be a sequence of closed, nonempty sets with $\left(\text{diam}(F_n)\right)_n = 0$. Then, $\bigcap F_n = \{x\}$ for some $x\in X$.
  \begin{description}
