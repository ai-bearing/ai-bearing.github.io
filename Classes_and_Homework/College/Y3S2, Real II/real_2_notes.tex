...
\end{enumerate}
  ...
  Let $f: \Omega \rightarrow [0,\infty]$ be integrable. Then, $\mu\left(\{x\mid f(x)\geq t\}\right) \leq \frac{1}{t}\int_{\Omega}f~d\mu$.
  \begin{description}
    \item[Proof:] Let $E = \{x\mid f(x) \geq t\}$. Thus, $f \geq t\mathbb{1}_E$.
  \end{description}
\end{document}
