...
\end{enumerate}
  ...
  We have that $x\sim_{X}x$ by taking $C = \{x\}$. Clearly, the relation is symmetric. To show transitivity, we need the following lemma:
  \begin{description}
  ...
  \begin{description}
    \item[Remark:] $[x]_{\sim} = \{y\in X\mid y\sim_{X}x\} = \bigcup_{x\in C} C $ with $C$ connected. This is the largest connected subset of $X$ containing $x$.
  \end{description}
\end{document}
