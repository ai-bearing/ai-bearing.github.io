          ...
          \begin{description}
            ...
            \item[Positive Definiteness:]
              \begin{align*}
                ...
                \shortintertext{and}
                f(0) = 0\\
                \shortintertext{so $f = \mathbb{0}_f$. Additionally, if $f = \mathbb{0}_f$, then $\Vert f \Vert_{\Lambda}=0$ since $|f(0)| = 0$ and $f(x)=f(y)=0$ for all $x,y\in [0,1]$.}
              \end{align*}
            ...
            \item[Triangle Inequality:] Let $f,g\in \Lambda[0,1]$. Then,
              \begin{align*}
                \Vert f + g \Vert &= |f(0) + g(0)| + \sup_{x,y\in[0,1],x\neq y}\frac{|f(x)+g(x)-(f(y)+g(y))}{|x-y|}\\
                                  &\leq |f(0)| + \sup_{x,y\in[0,1],x\neq y}\frac{|f(x)-f(y)|}{|x-y|}+ |g(0)| + \sup_{x,y\in[0,1],x\neq y}\frac{|g(x)-g(y)|}{|x-y|}\\
