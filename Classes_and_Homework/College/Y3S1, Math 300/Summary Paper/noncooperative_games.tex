...
\doublespacing
  ...
  Nash further developed the theory of non-cooperative games by showing in his Ph.D. Thesis (written in 1950), aptly titled ``Non-Cooperative Games,'' that every finite, $n$-player game has an equilibrium point consisting of some mix of every player's strategies. In it, he cited his earlier paper, ``Equilibrium Points in $N$-Person Games,'' published in the Proceedings of the National Academy of Sciences. This is the paper that I will examine and summarize.
  ...
  Nash refers to a strategy profile ``counter[ing]'' another in the paper as a mixed strategy for a certain player that maximizes expected payoff holding the other $n-1$ strategies in the $n$-tuple; in most textbooks, this is known as a best response, which is what I will refer to it as.\\
  ...
  \begin{description}
    \item[Correspondence:] A correspondence is a map from elements of a set $D$ to $\mathcal{P}(D)$.
