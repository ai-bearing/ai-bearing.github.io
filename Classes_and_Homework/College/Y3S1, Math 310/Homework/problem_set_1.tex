...
\begin{document}{
  ...
  \begin{problem}{Problem 4}
    ...
    Let $k: \mathbb{N}\rightarrow B\setminus A$. There are three cases: $A = \emptyset$, $A$ is finite, and $\exists f:\mathbb{N} \mapsto A$.
    \begin{description}
      \item[Case 1] If $A$ is the empty set, then $B\setminus A = B$, and since $\forall g: \mathbb{N} \rightarrow B$, $g$ is not a surjection, $k$ cannot be a surjection.
      \item[Case 2] If $A$ is finite, then $\exists g: \{1,2,\dots,n\} \mapsto A$, for $n\in \mathbb{N}$.
      \item[Case 3] If $\exists f: \mathbb{N} \mapsto A$.
    \end{description}
  \end{problem}
