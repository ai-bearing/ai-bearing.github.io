...
\begin{document}
  ...
  \begin{problem}{One Stage Deviation Property}
    A strategy provile in an infinitely repeated game with $\delta < 1$ is a SPE if and only if no player can increase their payoff by changing their action at a single information set, given the other players' strategies and the rest of their own strategy.
    \begin{itemize}
