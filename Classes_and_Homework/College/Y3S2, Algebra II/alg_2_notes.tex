...
\begin{document}
  ...
  \begin{enumerate}[(1)]
    ...
    \item An ideal $\mathcal{P}\subseteq R$ with $\mathcal{P} \neq R$ is a prime ideal if whenever $ab \in p$, then $a\in \mathcal{P}$ or $b\in \mathcal{P}$. We denote the collection of prime ideals $\text{Spec}(R)$.
  \end{enumerate}
