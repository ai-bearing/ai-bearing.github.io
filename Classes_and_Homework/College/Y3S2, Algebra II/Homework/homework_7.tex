...
\begin{document}
  \begin{center}
    ...
    {\bf Collaborators:} {Antonio Cabello, Timothy Rainone, Nate Hall} \\
  \end{center}
  \section{Problem 1}%
  ...
  \end{align*}
  However, by definition, this means that there is some $k\in \mathbb{F}_{p}$ such that $\alpha + k = 0$, meaning $\displaystyle a = \prod_{i=0}^{p-1}(\alpha + i) = 0$. $\bot$
  \section{Problem 4}%
