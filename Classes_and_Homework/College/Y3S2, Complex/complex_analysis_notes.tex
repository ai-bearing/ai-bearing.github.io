...
\section{Complex Numbers}%
  ...
  \begin{description}
    \item[Weierstrass $M$-Test:] Let $f_j: A\subseteq \C \rightarrow \C$, $j \in \Z_{\geq 0}$, with $f_j$ not necessarily continuous. Suppose $|f_j| \geq M_j$ on $A$. If $\sum M_j$ converges, then $\sum f_j(z)$ converges absolutely and uniformly on $A$.\\
