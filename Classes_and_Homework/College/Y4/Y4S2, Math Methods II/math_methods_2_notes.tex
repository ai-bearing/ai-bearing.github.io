...
\end{example}
 ...
 %\end{align*}
  ...
  \end{align*}
  \begin{example}[The Physicists' Green's Function]
    ...
    \end{align*}
  \end{example}
  \begin{example}[Poisson, One-Dimensional]
    ...
    \end{align*}
    We know that the solution is of the form $Ax + B$; however, we also need a discontinuity in the derivative such that we obtain a Delta function. In other words, we have $A_1 x + B_1$ when $x <t$ and $A_2 x + B_2$ when $x > t$.\newline
  ...
  \end{example}
  \begin{example}[Poisson's Equation in Multiple Dimensions]
    Consider the equation
    \begin{align*}
