...
\begin{solution}\hfill
  \begin{enumerate}[(a)]
    \item If $f\colon V\rightarrow k$ is a polynomial on $V$, take $f|_{W}\colon W\rightarrow k$ to obtain a polynomial on $W$.
    \item 
  \end{enumerate}
\end{solution}
...
\begin{solution}
  ...
  \begin{align*}
    \Gamma(V) &= k\left[ x_1,\dots,x_n \right]/\left\langle x_1-a_1,\dots,x_n-a_n \right\rangle\\
              ...
              &= k.
  \end{align*}
  This obviously implies (iii).\newline

  Now, if $\Dim_{k}\left( \Gamma\left( V \right) \right) < \infty$, we wish to show that 
\end{solution}
\subsection{Polynomial Maps}%
\begin{exercise}[Exercise 2.8]

\end{exercise}
\begin{exercise}[Exercise 2.12]
