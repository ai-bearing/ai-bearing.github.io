...
\begin{frame}[allowframebreaks]{Using Integration by Parts to find Excess Area Identity: Stokes's Theorem}
  In particular,
  \begin{align*}
    \overline{\frac{\partial}{\partial z}}\left(\left(\lambda\left(|z|\right)\right)\overline{h}\wedge \frac{\partial h}{\partial z}\right) &= \underbrace{\left(\lambda\left(|z|\right)\right)\overline{\frac{\partial h}{\partial z}}\wedge \frac{\partial h}{\partial z}}_{\text{area integrand}} + \left(\overline{\frac{\partial}{\partial z}}\lambda\left(|z|\right)\right)\overline{h}\wedge \frac{\partial h}{\partial z}.
  \end{align*}
\end{frame}
