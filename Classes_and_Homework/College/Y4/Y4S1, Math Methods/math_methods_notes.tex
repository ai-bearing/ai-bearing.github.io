...
\begin{example}[Gravity]
  ...
  Let's construct a planet that is a spherical shell at radius $a$ with mass $m$. Then, $\sigma = \frac{m}{4\pi a^2}$, with the area $dA$ has mass $dm = \sigma dA$. Thus, the mass at distance $\mathbf{r}$ is
  \begin{align*}
  ...
  This vector-valued integral sucks,\footnote{citation needed} so instead, we want to integrate
  \begin{align*}
