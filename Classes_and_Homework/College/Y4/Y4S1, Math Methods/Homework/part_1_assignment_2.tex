...
\begin{align*}
  \cos\left(N\phi\right) + i\sin\left(N\phi\right) &= \left(\cos \phi + i\sin\phi\right)^N\\
                                                   ...
                                                   &= \sum_{k=0}^{N}{N\choose k}\cos\left(\left(N-k\right)\frac{\pi}{2}\right)\left(\cos\phi\right)^k\left(\sin\phi\right)^{N-k} + i\left(\sum_{k=0}^{N}{N\choose k}\sin\left(\left(N-k\right)\frac{\pi}{2}\right)\left(\cos\phi\right)^k\left(\sin\phi\right)^{N-k}\right).
\end{align*}
...
\begin{align*}
  \sum_{n=-N}^{N}e^{inx} &= 1 + \sum_{n=1}^{N}e^{-inx} + \sum_{n=1}^{N}e^{inx}\\
                         &= \frac{1-e^{-i\left(N+1\right)x}}{1-e^{-ix}} + \frac{1-e^{i\left(N+1\right)x}}{1-e^{ix}} + 1\\
                         &= \frac{e^{-i\left(N+1\right)x} - 1}{e^{-ix} - 1} + \frac{e^{i\left(N+1\right)x}-1}{e^{ix}-1}
\end{align*}
\end{document}
