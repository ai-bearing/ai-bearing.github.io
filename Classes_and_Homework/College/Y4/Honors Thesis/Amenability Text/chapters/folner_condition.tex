...
While showing the existence of an invariant state is necessary and sufficient for showing a group is amenable, as well as showing the group is non-paradoxical, it is often difficult to find invariant states. However, we can often more easily create a sequence (or net) of finitely supported functions whose limit is an invariant state. This will require the use of the Følner condition.
\begin{definition}
...
\begin{definition}
  ...
  \end{align*}\label{def:approximate_mean}
\end{definition}
...
\begin{lemma}
  ...
  \end{align*}
  This is known as the layer cake representation for $f$.\label{lemma:layer_cake_representation}
\end{lemma}
