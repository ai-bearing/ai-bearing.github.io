...
This is the substance of the von Neumann conjecture --- and as it turns out, it is false. There are some groups that are not amenable, but do not contain a subgroup isomorphic to $F(a,b)$. In \cite{piecewise_projective_homeomorphisms}, Nicholas Monod showed that groups of piecewise projective homeomorphisms of the projective real line, $\R P^1$, are not amenable and do not contain any freely generated subgroups.\newline
