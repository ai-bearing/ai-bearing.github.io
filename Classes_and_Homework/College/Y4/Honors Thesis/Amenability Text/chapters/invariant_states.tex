...
\section{Amenability in Subgroups and Quotient Groups}%
We begin by defining a mean on $G$ --- note that this definition is slightly different from the one used in the proof in Theorem \ref{thm:tarski}. However, one can show that they are equivalent by letting $G$ act on itself by left-multiplication and taking $E = G$ in the proof of the theorem.
\begin{definition}
...
\begin{proof}\hfill
  ...
  \end{enumerate}
\end{proof}
\section{Enter Functional Analysis}%
