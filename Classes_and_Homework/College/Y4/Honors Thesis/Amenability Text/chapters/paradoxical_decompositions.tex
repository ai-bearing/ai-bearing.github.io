...
\begin{definition}[Euclidean Group]
  The {Euclidean group}, $E(n)$, consists of all isometries of a Eucliean space. An isometry of a Euclidean space consists of translations, rotations, and reflections.\newline
