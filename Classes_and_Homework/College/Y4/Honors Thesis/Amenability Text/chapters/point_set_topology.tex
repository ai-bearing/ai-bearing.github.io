...
\begin{example}\label{ex:results_follow_from_axiom_of_choice}\hfill
  \begin{itemize}
    ...
    %\item If $K$ is a nonempty, compact, and convex subset of a locally convex topological vector space, then $K$ has an extreme point.
  \end{itemize}
\end{example}
...
Compactness is effectively a topological version of finitude, as the definition herein effectively proscribes. We will encounter compactness a lot as we work through the functional analysis within this text, as well as use many of its properties and forms.
\begin{definition}
