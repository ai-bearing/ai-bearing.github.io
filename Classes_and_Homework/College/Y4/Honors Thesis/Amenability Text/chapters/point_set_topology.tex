...
\begin{definition}[Zermelo--Fraenkel Axioms]
  ...
  \end{itemize}
\end{definition}
The final axiom, the Axiom of Choice, is special, so we will state it separately.
...
\end{theorem}
Zorn's lemma is a more useful version of the Axiom of Choice, and can be used to prove the following theorems.
\begin{example}\hfill
  \begin{itemize}
