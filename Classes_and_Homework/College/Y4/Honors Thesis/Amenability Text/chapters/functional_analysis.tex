...
\end{definition}
\begin{remark}
It can be shown that every LCTVS has a neighborhood base consisting of \textsl{balanced} convex sets (see Definition \ref{def:vector_space_subset_operations}).
\end{remark}
