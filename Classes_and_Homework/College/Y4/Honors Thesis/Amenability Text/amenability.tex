...
Note that all groups in this thesis are endowed with the discrete topology. This is because I did not have enough time to learn about the more general case of topological groups, which are endowed with a locally compact topology that gives them interesting properties, and the topic of discrete groups is, evident in the length of this document, enough to discuss interesting properties.
