...
\title{Understanding Amenability in Discrete Groups\\{\large A Gentle Introduction to Higher Analysis}}
\author{Avinash Iyer}
\date{March 2025}
...
All vector spaces in this thesis are assumed to be over $\C$ unless otherwise specified, all groups are endowed with the discrete topology, and unless it is apparent otherwise, should be assumed countable and finitely generated. Nonetheless, even with this relatively limited view, we can still establish deep and profound results that provide a worthy harmonization of algebra and analysis.
...
This project's topic was originally conceived by professor Rainone in a footnote to one of the problems in problem set 8 of Real Analysis II in Spring 2024, where he mentioned the idea of an amenable group and had us prove the easy direction of Tarski's Theorem (Theorem \ref{thm:tarski}). After much hemming and hawing by yours truly, an appendix in the book \textit{Crossed Products of $C^{\ast}$-Algebras} by Dana Williams eventually convinced me that amenability was a topic worth exploring and understanding. It was a very good idea. Furthermore, as I dove deeper into the functional analysis necessary to understand the more heavy results in amenability, professor Rainone's draft textbook, \textit{Functional Analysis-En Route to Operator Algebras} was an incredible resource that I found both incredibly enlightening and an excellent reference.\newline
