...
Note that most of the groups in this thesis are countable and finitely generated, and all are endowed with the discrete topology. This is because if I dedicated the necessary time towards understanding and including the case of topological groups with any locally compact topology, this thesis would actually be longer than the Bible. Nonetheless, the case of countable discrete groups still provides very interesting case studies that strike at the heart of the foundations of mathematics.
...
\chapter{: Invariant States}\label{ch:invariant_states}
...
\chapter{We've Seen Groups from Both Sides Now: the Left-Regular Representation}\label{ch:left_regular_representation}
